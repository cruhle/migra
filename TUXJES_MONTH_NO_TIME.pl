...
printf($fpo "DATE;TIME;AREA;JOB_NUMBER;JOB_NAME;STEP_NAME;SECONDS;RETURN_CODE\n");
printf($fpe "DATE;TIME;AREA;JOB_NUMBER;JOB_NAME;STEP_NAME;SECONDS;RETURN_CODE\n");
