...
$ficheiro =~ /(\d+)/;
$ficheiro = '/tmp/pkis/submited_started_ended_XX_neg_'. $1 .'.csv';
...
printf($fp "%s\n",$0);
printf($fp "SERVER;JOB_NUMBER;JOB_NAME;DOMAIN;CLASS;SUBMITTED;STARTED;ENDED;RUNTIME_SECONDS;RETURN_CODE\n");
