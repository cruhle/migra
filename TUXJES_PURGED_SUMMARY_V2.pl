...
$ficheiro =~ /(\d+)/;
$ficheiro = '/tmp/pkis/PURGED_SUMMARY_V2_XX_'. $1 .'.csv';
...
printf($fp "%s\n",$0);
printf($fp "JOB_NUMBER;JOB_NAME;DOMAIN;SUBMITTED;STARTED;ENDED;AUTOPURGED;RETURN_CODE;STATUS;VALUE\n");
